...
var activities = {
  ...
  bag: "images/bag5.png",
  bagDots: "images/55.png",
};

var info = [education, employment, skills, projects, activities];
var currIdx = 0;
...
function rotateLeft() {
  ...
  bagDots.src = info[currIdx].bagDots;
}
